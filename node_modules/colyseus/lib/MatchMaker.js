...
class MatchMaker {
    ...
    create(roomName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!handler) {
                throw new MatchMakeError_1.MatchMakeError(`no available handler for "${roomName}"`, Protocol_1.Protocol.ERR_MATCHMAKE_NO_HANDLER);
            }
    ...
    queryRoom(roomName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.awaitRoomAvailable(roomName, () => __awaiter(this, void 0, void 0, function* () {
                const handler = this.handlers[roomName];
                if (!handler) {
                    throw new MatchMakeError_1.MatchMakeError(`no available handler for "${roomName}"`, Protocol_1.Protocol.ERR_MATCHMAKE_NO_HANDLER);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (room.onCreate) {
                try {
                    ...
                    throw new MatchMakeError_1.MatchMakeError(e.message, Protocol_1.Protocol.ERR_MATCHMAKE_UNHANDLED);
                }
            }
    ...
    reserveSeatFor(room, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [_, reserveSeatSuccessful] = yield this.remoteRoomCall(room.roomId, '_reserveSeat', [sessionId, options]);
    ...
    awaitRoomAvailable(roomToJoin, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                const concurrencyKey = this.getHandlerConcurrencyKey(roomToJoin);
                const concurrency = (yield this.presence.incr(concurrencyKey)) - 1;
                ...
                setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        yield this.presence.decr(concurrencyKey);
                    }
                }), concurrencyTimeout);
            }));
        });

...
export declare class MatchMaker {
    ...
    joinOrCreate(roomName: string, options: ClientOptions): Promise<unknown>;
    create(roomName: string, options: ClientOptions): Promise<{
        room: RoomListingData;
        sessionId: string;
    }>;
    join(roomName: string, options: ClientOptions): Promise<unknown>;
    ...
    protected awaitRoomAvailable(roomToJoin: string, callback: Function): Promise<RoomListingData>;
